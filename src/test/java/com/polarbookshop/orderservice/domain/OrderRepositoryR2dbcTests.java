...
class OrderRepositoryR2dbcTests {
    ...
    @Autowired //injecting with autowired, only in tests from spring 4.3 injection is done on bl on constructor
    ...
    void createRejectedOrder() {
        ...
        StepVerifier.create(orderRepository.save(rejectedOrder))//Initializes a StepVerifier object with the object returned by OrderRepository
                    .expectNextMatches(
